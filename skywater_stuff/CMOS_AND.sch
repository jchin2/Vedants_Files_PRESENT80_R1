...
N 520 -530 530 -530 { lab=GND}
N 530 -530 530 -490 { lab=GND}
N 520 -490 530 -490 { lab=GND}
N 520 -640 530 -640 { lab=VDD}
N 530 -690 530 -640 { lab=VDD}
...
C {sky130_fd_pr/nfet_01v8.sym} 310 -450 0 0 {name=M7
L=0.15
W=1.5
nf=1 
mult=1
