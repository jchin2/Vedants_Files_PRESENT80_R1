...
C {EESPFAL_XOR_v3.sym} 780 -750 0 0 {name=x7}
C {EESPFAL_NOR_v3.sym} 780 -600 0 0 {name=x1}
C {EESPFAL_NOR_v3.sym} 1770 -610 0 0 {name=x2}
C {EESPFAL_NAND_v3.sym} 780 -440 0 0 {name=x3}
C {EESPFAL_NAND_v3.sym} 1280 -480 0 0 {name=x4}
C {EESPFAL_NAND_v3.sym} 1280 -700 0 0 {name=x5}
