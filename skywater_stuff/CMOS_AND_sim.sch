...
C {devices/vsource.sym} -90 -420 0 0 {name=Vin1 value=pulse(0,1.8,0,1ps,1ps,100ns,200ns)}
...
C {devices/vsource.sym} -50 -400 0 0 {name=Vin3 value=pulse(0,1.8,0,1ps,1ps,200ns,400ns)}
...
C {CMOS_AND.sym} 410 -550 0 0 {name=x1}
