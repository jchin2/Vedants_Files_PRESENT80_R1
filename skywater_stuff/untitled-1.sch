...
C {devices/gnd.sym} 930 -760 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 930 -610 0 0 {name=l2 lab=GND}
C {devices/gnd.sym} 930 -450 0 0 {name=l3 lab=GND}
...
C {devices/gnd.sym} 1430 -710 0 0 {name=l40 lab=GND}
C {devices/gnd.sym} 1430 -490 0 0 {name=l41 lab=GND}
...
C {devices/gnd.sym} 1920 -620 0 0 {name=l70 lab=GND}
C {devices/lab_pin.sym} 1950 -640 2 0 {name=l73 sig_type=std_logic lab=s0_bar}
C {devices/lab_pin.sym} 1950 -660 2 0 {name=l74 sig_type=std_logic lab=s0}
