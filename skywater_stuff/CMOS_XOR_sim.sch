...
C {devices/vsource.sym} -200 -400 0 0 {name=Vin1 value=pulse(0,1.8,0,50ps,50ps,100ns,200ns)}
...
C {devices/vsource.sym} -170 -370 0 0 {name=Vin2 value=pulse(1.8,0,0,50ps,50ps,100ns,200ns)}
C {devices/gnd.sym} -170 -320 0 0 {name=l14 lab=GND}
C {devices/lab_pin.sym} -200 -250 1 0 {name=l25 sig_type=std_logic lab=B}
C {devices/vsource.sym} -200 -200 0 0 {name=Vin3 value=pulse(0,1.8,0,50ps,50ps,200ns,400ns)}
C {devices/gnd.sym} -200 -150 0 0 {name=l26 lab=GND}
C {devices/lab_pin.sym} -170 -220 1 0 {name=l27 sig_type=std_logic lab=B_bar}
C {devices/vsource.sym} -170 -170 0 0 {name=Vin4 value=pulse(1.8,0,0,50ps,50ps,200ns,400ns)}
...
C {devices/capa.sym} 580 -600 2 0 {name=C1
m=1
value=20f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 580 -630 2 0 {name=l4 lab=GND}
