...
N 1530 -650 1560 -650 { lab=Dis3}
N 1530 -630 1560 -630 { lab=CLK3}
...
N 1860 -730 1890 -730 { lab=GND}
N 1240 -450 1270 -450 { lab=GND}
N 1240 -690 1270 -690 { lab=GND}
N 1240 -890 1270 -890 { lab=GND}
N 700 -430 730 -430 { lab=GND}
N 700 -540 730 -540 { lab=GND}
N 700 -690 730 -690 { lab=GND}
N 700 -810 730 -810 { lab=GND}
N 700 -970 730 -970 { lab=GND}
C {devices/iopin.sym} 1890 -730 0 0 {name=p1 lab=GND}
...
C {devices/lab_pin.sym} 1270 -450 2 0 {name=l12 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 1270 -690 2 0 {name=l13 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 1270 -890 2 0 {name=l1 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 730 -430 2 0 {name=l2 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 730 -540 2 0 {name=l10 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 730 -690 2 0 {name=l14 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 730 -810 2 0 {name=l15 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 730 -970 2 0 {name=l16 sig_type=std_logic lab=GND}
